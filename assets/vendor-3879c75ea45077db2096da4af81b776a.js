...
Object.defineProperty(e,"__esModule",{value:!0}),e.default="2.17.0"}),define("squishable-container/components/squishable-container",["exports","squishable-container/templates/components/squishable-container","squishable-container/raf"],function(e,t,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
var n=["em","vw","px","rem","ex"]
e.default=Ember.Component.extend({layout:t.default,width:100,unit:"vw",classNames:["squishable-container"],init:function(){this._super(),this._scale=1},innerStyle:Ember.computed("width","unit",function(){var e=this.get("width"),t=this.get("unit")
if("number"!=typeof e)throw new Error("squishable-container: width must be a number, not "+e)
if(-1===n.indexOf(t))throw new Error("squishable-container: unit must be one of ["+n.join(", ")+"], not "+t)
return Ember.String.htmlSafe("width: "+e+t)}),didInsertElement:function(){var e=this;(0,r.requestAnimationFrame)(function(){return e.updateScale()})},updateScale:function(){var e=this
if(!this.isDestroyed){var t=this.$().width()/this.$().children(":first").width()
Math.abs(this._scale-t)>1e-4&&(this.$().css({transform:"scale("+t+")"}),this._scale=t),(0,r.requestAnimationFrame)(function(){return e.updateScale()})}}})}),define("squishable-container/raf",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.requestAnimationFrame=function(e){if(window.requestAnimationFrame)return window.requestAnimationFrame(e)
return setTimeout(e,33)},e.cancelAnimationFrame=function(e){if(window.cancelAnimationFrame)return window.cancelAnimationFrame(e)
return clearTimeout(e)}}),define("squishable-container/templates/components/squishable-container",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"8WTY1yxs",block:'{"symbols":["&default"],"statements":[[6,"div"],[10,"style",[18,"innerStyle"],null],[7],[0,"\\n  "],[11,1],[0,"\\n"],[8],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"squishable-container/templates/components/squishable-container.hbs"}})})
